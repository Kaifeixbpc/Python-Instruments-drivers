...
import time
func_list=('set_DC_offset','set_amplitude','set_frequency','ramp_offset','ramp_to_zero')
...
#        self.func_list={'set_DC_offset','set_amplitude','set_frequency','ramp_offset','ramp_to_zero'}
    ...
    def ramp_offset(self,setp,stepsize=0.01,time_per_step=0.1):
...
#        print('Output voltage from AG33500B is zero now!')
    ...
    def call_AG_func(self, arg,*args):
        
        self.func_list[arg].__get__(self, type(self))(*args)
